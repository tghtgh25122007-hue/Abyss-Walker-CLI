...
## 🌟 Điểm sáng của dự án: Thuật toán A* kết hợp Priority Queue

**Tại sao đây là tính năng hay nhất?**
Với thuật toán BFS thông thường, sự cẩn thận loang đều ra mọi hướng giúp chắc chắn tìm được đường đi ngắn nhất. Tuy nhiên, đôi khi **điểm mạnh lại trở thành điểm yếu**: việc quét mù quáng khiến BFS ngốn quá nhiều tài nguyên bộ nhớ trên một bản đồ lớn. Thuật toán A* (A-Star) được đưa vào để khắc phục triệt để vấn đề này nhờ khả năng "đánh hơi" hướng đi.

**Cách thức hoạt động:**
1. **Định hướng bằng Heuristic:** Áp dụng công thức $F = G + H$ để chấm điểm từng ô. Trong đó $G$ là số bước đã đi, $H$ là khoảng cách chim bay dự đoán tới đích.
2. **Lõi cấu trúc dữ liệu:** Các ô đang xét được đẩy vào `Priority Queue` (Min-Heap). Cấu trúc này tự động sắp xếp để luôn đẩy ô có điểm $F$ nhỏ nhất (gần đích nhất) lên đầu.
3. **Kết quả:** Vòng lặp luôn rút ô tối ưu nhất ra để đi trước, giúp thuật toán lao thẳng về đích một cách thông minh thay vì loang vòng tròn như BFS.
